    ...
    function buildOrContextImpl(callName, buildKey, sendRequest, sendResponse, refs, streamIn, requestCallbacks, options, isTTY2, defaultWD2, callback) {
      ...
      function buildOrContextContinue(requestPlugins, runOnEndCallbacks, scheduleOnDisposeCallbacks) {
        ...
        const buildResponseToResult = (response, callback2) => {
          ...
          if (response.metafile && response.metafile.length) result2.metafile = parseJSON(response.metafile);
      ...
      if (/\.zip\//.test(binPath)) {
        ...
        if (pnpapi) {
          ...
          const binTargetPath = path2.join(
            ...
            ".cache",
            "esbuild",
            `pnpapi-${pkg.replace("/", "-")}-${"0.28.2"}-${path2.basename(subpath)}`
          );
...
console.log("\u{1F528} Building Vercel serverless bundle...");
var result = await (0, import_esbuild.build)({
  ...
  banner: {
    js: `const __bundled_meta_url = __filename;`
  },
  define: {
...
var entryContent = `// Vercel Serverless Function \u2014 auto-generated bundle
...
console.log("\u2705 Bundle created: api/_app.cjs + api/index.js");
